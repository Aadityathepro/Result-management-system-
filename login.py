...
class Login_page:
    def __init__(self, window):
        ...
        self.lable_imag = Image.open("D:\\studennt_data\\welcom.png")
        self.lable1_imag = self.lable_imag.resize((200,200))
        self.lable2_imag = ImageTk.PhotoImage(self.lable1_imag)
        self.lable3_imag = Button(login_frame, image=self.lable2_imag,bd=5,background="#FFE15C",command=self.master)
        self.lable3_imag.place(x=370, y=45)
        # #master
        # self.btn_img = ImageTk.PhotoImage(file="D:\\studennt_data\\register.png")
        # btn = Button(login_frame, image=self.btn_img, cursor="hand2", command=self.register_data)
