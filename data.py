...
class RMS:
    def __init__(self, window):
        ...
        self.logo_dash = ImageTk.PhotoImage(file="D:\\studennt_data\\logo_p.png")
        ...
        #   BODY IMAGE SECTION
        self.lable_imag = Image.open("D:\\studennt_data\\bg.png")
        ...
        #   BASE TEXT
        footer = Label(self.window,text="SRMS-Student Result Management System \n Contact us for Techinical issue : 9339xxxx61",font=("goudy ols style", 15), bg="#262626", fg="white")
